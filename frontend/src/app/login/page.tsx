			...
			<div className="w-full max-w-sm space-y-6">
				...
				<div className="rounded-lg border border-white/10 bg-[#111] p-6 space-y-4">
					...
					<button
						...
						className="flex w-full items-center justify-center gap-3 rounded-lg border border-white/10 px-4 py-2.5 text-sm font-medium transition-colors hover:border-white/20 hover:bg-[#1a1a1a]"
					>
